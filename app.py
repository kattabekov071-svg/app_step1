...
def admin_panel(request: Request):
    ...
    log_rows = "".join([f"<tr class='border-t border-[#2a2e39]'><td class='p-3 text-gray-400'>{log['timestamp']}</td><td class='p-3 text-white'>{log['username']}</td><td class='p-3 text-cyan-400'>{log['action']}</td><td class='p-3 text-gray-300'>{log['ip']}</td><td class='p-3 text-gray-300'>{log['user_agent'][:40]}...</td></tr>" for log in logs]) or '<tr><td colspan="5" class="p-4 text-center text-gray-500">Нет записей</td></tr>'
        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="bg-[#1e222d] border border-[#2a2e39] p-6 rounded shadow">
                ...
                <table class="w-full text-left text-xs">
                    <thead><tr class="text-gray-500 border-b border-[#2a2e39]"><th class="pb-3">Время</th><th class="pb-3">Пользователь</th><th class="pb-3">Действие</th><th class="pb-3">IP</th><th class="pb-3">Браузер</th></tr></thead>
